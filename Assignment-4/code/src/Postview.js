            ...
            <div className="main-info" key={idx} style={{ margin: "20px 0" }}>
              ...
              <section className="main-container">
                ...
                <div className="image-container">
                  <img src={propos.PostImage} alt="post-pic" />
                </div>
                ...
                <footer>
                  <div className="likes-share-date">
                    <div className="like-share">
                      ...
                      <img src={sendbutton} alt="share" />
                    </div>
                    <div className="date">
                      {new Date(propos.date).toLocaleDateString}
                    </div>
                  </div>
...
// json-server --watch Mock-data/user.json --port 3004
